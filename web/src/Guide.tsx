  ...
  return (
    <main className="guide-page">
      ...
      <section id="live" className="panel guide-step">
        ...
        <p>
          현금으로 시작하는 전략은 토스 USD, 업비트 KRW 사용 가능 현금이 전략
          예산을 충족해야 합니다. 입금만으로 봇 예산이 늘어나지 않습니다. 같은
          종목의 기존 보유분·수동 주문이 있으면 현금 시작을 거절합니다. 보유
          코인은 아래의 전량 편입 절차를 따릅니다.
        </p>
        <p>
          토스는 당일 지정가, 업비트는 지정가 주문을 사용합니다. 종목당 한
          주문을 처리하고 60초가 지나면 남은 주문의 취소를 요청합니다. 업비트
          주문 응답이 끊기면 식별자로 조회하며 새 주문으로 재전송하지 않습니다.
        </p>
        <p>
      ...
      <section id="inventory-grid" className="panel guide-step">
        ...
        <ol>
          ...
          <li>
            최신 매도 가능 전량을 기본 5단계·2% 간격으로 나눕니다. 단계 수와
            간격은 조정할 수 있으며 이 기본값은 수익 최적화 결과가 아닙니다.
          </li>
          <li>
        ...
        <p>
          ...
          매도가에서 다시 매도합니다. 단계별 최대 수량을 유지하고 이익은 원화로
          남습니다. 매도되지 않은 단계의 코인이나 다른 원화 잔액을 재매수에
          사용하지 않습니다.
        </p>
        <p>
          가격에 도달할 때 종목당 한 주문씩 처리합니다. 미체결은 60초 후 취소를
          요청하며 다음 시세에서 다시 판단합니다. 부분 체결과 재시작 후에도
          단계별 코인·매도대금을 유지합니다.
        </p>
        <p>
