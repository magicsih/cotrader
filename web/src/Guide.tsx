  ...
  return (
    <main className="guide-page">
      ...
      <div className="guide-hero">
        ...
        <p>
          시장 선택 → 데이터 수집 → 설정 탐색 → 다른 기간 검증 → 모의매매 순서로
          진행합니다. 실제 종목의 시세를 쓰는 모의매매에는 입금이 필요하지
          않습니다.
        </p>
      </div>
      ...
      <section id="data" className="panel guide-step">
        ...
        <p>
          ...
          <strong>
            DEMO·가상 예제 데이터는 실제 종목 검증에 사용하지 않습니다.
          </strong>
        </p>
      </section>
      ...
      <section id="live" className="panel guide-step">
        ...
        <p>
          ...
          <strong>실거래 기록</strong>은 기록 조회 화면을 고르는 버튼이며 주문 권한을
          켜는 스위치가 아닙니다.
        </p>
        <p>
